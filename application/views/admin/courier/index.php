        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Courier List</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                <!--end::Page title-->
                <!--begin::Actions-->
                <div class="d-flex align-items-center gap-2 gap-lg-3">s
                                    ...
                                    <div class="px-7 py-5" data-kt-user-table-filter="form">
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <select class="form-select form-select-solid fw-bold" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-user-table-filter="role" data-hide-search="true">
                                                ...
                                                <option value="Analyst">Customer Service</option>
                                                <option value="Trial">Driver</option>
                                                <option value="Support">Courier</option>
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <select class="form-select form-select-solid fw-bold" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-user-table-filter="two-step" data-hide-search="true">
                                                ...
                                                <option value="Enabled">Inactive</option>
                                            </select>
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Actions-->
                                            ...
                                            <form id="kt_modal_export_users_form" class="form" action="#">
                                                ...
                                                <div class="fv-row mb-10">
                                                    ...
                                                    <select name="role" data-control="select2" data-placeholder="Select a role" data-hide-search="true" class="form-select form-select-solid fw-bold">
                                                        ...
                                                        <option value="Administrator">Administrator</option>
                                                        <option value="Analyst">Customer Service</option>
                                                        <option value="Developer">Driver</option>
                                                        <option value="Support">Courier</option>
                                                        <option value="Trial">Staff</option>
                                                    </select>
                                                    <!--end::Input-->
