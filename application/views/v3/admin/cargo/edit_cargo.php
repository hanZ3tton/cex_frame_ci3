                    ...
                    <form id="kt_ecommerce_settings_general_form" class="form" action="#">
                        ...
                        <div class="row row-cols-1 row-cols-sm-3 row-cols-md-3 row-cols-lg-2 g-5">
                            ...
                            <div class="col">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid" name="ReceiverProvince" value="Samuel Toko Choir" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
                            ...
                            <div class="col">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid" name="ReceiverCity" value="Samuel Toko Choir" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
                        ...
                        <div class="row row-cols-1 row-cols-sm-3 row-cols-md-3 row-cols-lg-3 g-5">
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid" name="ReceiverCity" value="diniheryani3@gmail.com" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid" name="ReceiverCity" value="085961176347" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid" name="ReceiverCity" value="12630" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
                        ...
                        <div class="row g-9 mb-7">
                            ...
                            <div class="col-md-12 fv-row">
                                ...
                                <textarea class="form-control form-control-solid" name="SenderAddress" rows="4"> Choir Express Pusat Jl. Timbul Raya. 3C & 3D, RT.7/RW.4, Cipedak, Kec. Jagakarsa, Kota Jakarta Selatan, DKI Jakarta 12630 </textarea>
                            </div>
                        </div>
                        <!--end::Input group-->
                        <!--begin::Separator-->
                        ...
                        <div class="row g-9 mb-7">
                            ...
                            <div class="col-md-4 fv-row">
                                <div class="fv-row">
                                    ...
                                    <input type="number" class="form-control form-control-solid" name="length" value="10" />
                                </div>
                            </div>
                            <!-- Width input column -->
                            <div class="col-md-4 fv-row">
                                <div class="fv-row">
                                    ...
                                    <input type="number" class="form-control form-control-solid" name="width" value="10"/>
                                </div>
                            </div>
                            <!-- Height input column -->
                            <div class="col-md-4 fv-row">
                                <div class="fv-row">
                                    ...
                                    <input type="number" class="form-control form-control-solid" name="height" value="10"/>
                                </div>
                            </div>
                        </div>
                        <!-- Second row for Weight and Total Qty -->
                        <div class="row g-9 mb-7">
                            ...
                            <div class="col-md-6 fv-row">
                                <div class="fv-row">
                                    ...
                                    <input type="number" class="form-control form-control-solid" name="weight" value="7.00"/>
                                </div>
                            </div>
                            <!-- Total Qty input column -->
                            <div class="col-md-6 fv-row">
                                <div class="fv-row">
                                    ...
                                    <input type="number" class="form-control form-control-solid" name="total_qty" value="1" />
                                </div>
                            </div>
                        </div>
                        <!-- Third row for Cost and Calculate Button -->
                            ...
                            <div class="col-md-4 fv-row">
                                <div class="fv-row">
                                    ...
                                    <select class="form-select form-control-solid" data-control="select2" data-placeholder="Select Package Type">
                                        ...
                                        <option value="Life Electronics">Life Electronics</option>
                                    </select>
                                </div>
                            </div>
                            <!-- Width input column -->
                        ...
                        <div class="row g-9 mb-7">
                            ...
                            <div class="col-md-4 fv-row">
                                <div class="fv-row">
                                    ...
                                    <input type="select" class="form-control form-control-solid" name="ItemType" value="Others" />
                                </div>
                            </div>
                            <!-- Width input column -->
                            <div class="col-md-4 fv-row">
                                <div class="fv-row">
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="ItemName" value="Test" />
                                </div>
                            </div>
                            <!-- Height input column -->
                            <div class="col-md-4 fv-row">
                                <div class="fv-row">
                                    ...
                                    <input type="number" class="form-control form-control-solid" name="Quantity" value="1" />
                                </div>
                            </div>
                        </div>
                        <!-- Second row for Weight and Total Qty -->
                        <div class="row g-9 mb-7">
                            ...
                            <div class="col-md-6 fv-row">
                                <div class="fv-row">
                                    ...
                                    <input type="number" class="form-control form-control-solid" name="ItemValue" value="1" />
                                </div>
                            </div>
                            <!-- Total Qty input column -->
                            <div class="col-md-6 fv-row">
                                <div class="fv-row">
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="Currency" value="IDR"/>
                                </div>
                            </div>
                        </div>
                        <div class="row g-9 mb-7">
                            ...
                            <div class="col-md-12 fv-row">
                                ...
                                <textarea class="form-control form-control-solid" name="ItemDescription" rows="4">Test</textarea>
                            </div>
                        </div>
                        <!-- Third row for Cost and Calculate Button -->             
                        <!--end::Input group-->
