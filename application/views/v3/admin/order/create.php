            ...
            <div class="card card-flush h-lg-100" id="kt_contacts_main">
                ...
                <div class="card-body pt-5">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                        ...
                        <tbody class="text-gray-600 fw-semibold" id="table_detail_item">
                        </tbody>
                    </table>
...
<script>
    $(document).ready(function() {
        $.get('<?= base_url("v3/admin/order/table_detail_item/" . $order->code) ?>', function(data) {
            $('#table_detail_item').html(data);
        });
    });
</script>